...
const OrderDetail = ({ order }) => {
    ...
    const setQuantityValue = (value) => {
        ...
        setQuantityError(
            isQuantityInvalid(quantityValue, order.metadata.quantity)
        )
                    ...
                    <Grid container>
                        <Grid item className={classes.rejectAndNegotiateText}>
                            <Typography
                                ...
                                color="textSecondary"
                            >
                                In the case you can&apos;t meet the requirements
                                of the purchase order, you may negotiate the
                                quantity and set a delivery date of the
                                remaining items.
                            </Typography>
                        </Grid>
                        <OrderQuantityInput
