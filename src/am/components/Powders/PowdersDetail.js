...
const testList = [
    ...
    [
        'ASTM B417',
        'Density of non-free-flowing powders using the carney funnel',
    ],
            ...
            <Box>
                ...
                <Paper elevation={0} className={classes.detailContainer}>
                    <Box className={classes.detailHeaderContainer}>
                        ...
                        <Grid
                            className={classes.detailHeaderRow}
                            container
                            direction="row"
                        >
                    ...
                    {labTest === null ? (
                        <Box className={classes.actionsContainer}>
                            <Typography>
                                Select a company to send the samples for
                                testing:
                            </Typography>
                            <Box className={classes.formControls}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <option value={identities.lab}>
                                            TruFORM
                                        </option>
                                        <option value={identities.amlab}>
                                            Aero Labs
                                        </option>
                                    </Select>
                                </FormControl>
